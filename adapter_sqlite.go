...
func (m *sqliteAdapter) Name() string {
	return "sqlite"
}

func (m *sqliteAdapter) Connect(config *ConnectConfig) (*sqlx.DB, error) {
	return sqlx.Connect(m.Name(), config.Dsn)
}

func (m *sqliteAdapter) GenDDL(sortedNames []string, schemas map[string]*Schema, ignoreComments ...bool) string {
	var ddls []string
...
func (m *sqliteAdapter) CreateClauses() string {
	//TODO implement me
	panic("implement me")
}

func (m *sqliteAdapter) DeleteClauses() string {
	//TODO implement me
	panic("implement me")
}

func (m *sqliteAdapter) UpdateClauses() string {
	//TODO implement me
	panic("implement me")
}

func (m *sqliteAdapter) QueryClauses() string {
	//TODO implement me
	panic("implement me")
}
